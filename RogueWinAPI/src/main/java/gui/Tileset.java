...
/**
 *
 * Creates an array of tiles based off of an image passed to the object. Slices
 * the image into a grid of tiles for the tileset
 *
...
public class Tileset {
     ...
     * @return The requested tile at (r,c)
     */
